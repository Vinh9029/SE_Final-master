    ...
    <div class="register-container">
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="input-group">
                ...
                <input type="password" name="password" placeholder="Password" required id="password" oninput="checkStrength()">
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (password !== confirmPassword) {
                msg = '<i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu không khớp.';
            } else if (password.length < 8) {
                msg = '<i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu phải có ít nhất 8 ký tự.';
            } else if (!hasLowercase) {
                msg = '<i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu phải chứa ít nhất một chữ cái viết thường.';
            } else if (!hasSymbol) {
                msg = '<i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu phải chứa ít nhất một ký tự đặc biệt.';
            } else if (!hasUppercase) {
                msg = '<i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu phải chứa ít nhất một chữ cái viết hoa.';
            }
