...
if ($is_ajax && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        echo json_encode(['success' => true, 'message' => 'Đã duyệt bài viết thành công!', 'redirect' => 'blog/list.php']);
    } else {
        echo json_encode(['success' => false, 'message' => 'Lỗi khi duyệt bài viết: ' . $conn->error]);
    }
    $stmt->close();
    exit();
}

// Logic cho trường hợp non-AJAX GET (ví dụ: truy cập trực tiếp)
